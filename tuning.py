...
export CUDA_VISIBLE_DEVICES=1; python train_cifar.py --arch preactresnet18 --alpha 0.2 --add_noise_level 0.0 --mult_noise_level 0.0 --manifold_mixup 1 --seed 1
export CUDA_VISIBLE_DEVICES=1; python train_cifar.py --arch preactresnet18 --alpha 1.0 --add_noise_level 0.0 --mult_noise_level 0.0 --manifold_mixup 1 --seed 1
...
export CUDA_VISIBLE_DEVICES=0; python train_cifar.py --name cifar100 --arch preactwideresnet18 --alpha 0.0 --add_noise_level 0.0 --mult_noise_level 0.0 --seed 1
export CUDA_VISIBLE_DEVICES=1; python train_cifar.py --name cifar100 --arch preactwideresnet18 --alpha 1.0 --add_noise_level 0.0 --mult_noise_level 0.0 --seed 1
...
export CUDA_VISIBLE_DEVICES=1; python train_cifar.py --name cifar100 --arch preactwideresnet18 --alpha 2.0 --add_noise_level 0.0 --mult_noise_level 0.0 --manifold_mixup 1 --seed 1
